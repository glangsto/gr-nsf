...
# Generated: Sat May 19 11:29:50 2018
##################################################
...
class NsfIntegrate60(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ra_vmedian_0_1_0_0 = ra_vmedian.ra_vmedian(fftsize, 4)
        ...
        self.Ra_Integrate_1 = ra_integrate.ra_integrate('Watch.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record, obstype, (4**6), units, 295., 10.)
        self.Ra_Ascii_Sink_0 = ra_ascii_sink.ra_ascii_sink('Watch.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record,
            obstype, 4**6, nAve, Telescope, Device, Gain1, Gain2, Gain3)
        ...
        self.connect((self.ra_vmedian_0_1, 0), (self.ra_vmedian_0_1_0_0, 0))
        self.connect((self.ra_vmedian_0_1_0, 0), (self.Ra_Ascii_Sink_0, 0))
        self.connect((self.ra_vmedian_0_1_0, 0), (self.Ra_Integrate_1, 0))
        self.connect((self.ra_vmedian_0_1_0_0, 0), (self.ra_vmedian_0_0_0, 0))
