...
# Generated: Mon Aug 20 07:47:54 2018
##################################################
...
class NsfIntegrate63(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "NsfIntegrate63")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.ConfigFile = ConfigFile = "Watch63.conf"
...
def main(top_block_cls=NsfIntegrate63, options=None):
