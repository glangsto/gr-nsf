...
# Description: Test of Radio Astronomy Ascii Sink Block
# Generated: Sat May 19 11:49:42 2018
##################################################
...
class NsfIntegrate20(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.ConfigFile = ConfigFile = "Watch20.conf"
        ...
        except: device_save = 'airspy,pack=1,bias=1'
        ...
        self.top_grid_layout.addWidget(self._units_tool_bar, 2,0,1,2)
        self._obstype_options = (0, 1, 2, 3, )
        self._obstype_labels = ('Survey', 'Hot', 'Cold', 'Ref', )
        self._obstype_tool_bar = Qt.QToolBar(self)
        self._obstype_tool_bar.addWidget(Qt.QLabel('Obstype'+": "))
        ...
        self.top_grid_layout.addWidget(self._obstype_tool_bar, 1,0,1,2)
        self._observer_tool_bar = Qt.QToolBar(self)
        self._observer_tool_bar.addWidget(Qt.QLabel('Obs'+": "))
        ...
        self.top_grid_layout.addWidget(self._observer_tool_bar, 0,4,1,3)
        ...
        self.top_grid_layout.addWidget(self._nAve_tool_bar, 2,2,1,1)
        ...
        self.top_grid_layout.addWidget(self._fftsize_tool_bar, 2,3,1,1)
        ...
        self.top_grid_layout.addWidget(self._Xaxis_tool_bar, 11,3,1,3)
        ...
        self.top_grid_layout.addWidget(self._Telescope_tool_bar, 1,4,1,3)
        ...
        self.top_grid_layout.addWidget(self._Record_tool_bar, 0,0,1,2)
        ...
        self.top_grid_layout.addWidget(self._Gain3_tool_bar, 2,7,1,1)
        ...
        self.top_grid_layout.addWidget(self._Gain2_tool_bar, 1,7,1,1)
        ...
        self.top_grid_layout.addWidget(self._Gain1_tool_bar, 0,7,1,1)
        ...
        self.top_grid_layout.addWidget(self._Frequency_tool_bar, 1,2,1,1)
        ...
        self.top_grid_layout.addWidget(self._Elevation_tool_bar, 0,3,1,1)
        ...
        self.top_grid_layout.addWidget(self._Device_tool_bar, 2,4,1,3)
        ...
        self.top_grid_layout.addWidget(self._Bandwidth_tool_bar, 1,3,1,1)
        ...
        self.top_grid_layout.addWidget(self._Azimuth_tool_bar, 0,2,1,1)
        self.ra_vmedian_0_1_0 = ra_vmedian.ra_vmedian(fftsize, 4)
        self.ra_vmedian_0_1 = ra_vmedian.ra_vmedian(fftsize, 4)
        self.ra_vmedian_0_0_0 = ra_vmedian.ra_vmedian(fftsize, 4)
        ...
        self.Ra_Integrate_1 = ra_integrate.ra_integrate('Watch.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record, obstype, (4**4), units, 295., 10.)
        self.Ra_Ascii_Sink_0 = ra_ascii_sink.ra_ascii_sink('Watch.not', observer, fftsize, Frequency, Bandwidth, Azimuth, Elevation, Record,
            obstype, 4**5, nAve, Telescope, Device, Gain1, Gain2, Gain3)
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.ra_vmedian_0, 0))
        ...
        self.connect((self.ra_vmedian_0_0_0, 0), (self.Ra_Integrate_1, 0))
        self.connect((self.ra_vmedian_0_0_0, 0), (self.ra_vmedian_0_1_0, 0))
        self.connect((self.ra_vmedian_0_1, 0), (self.ra_vmedian_0_0_0, 0))
        self.connect((self.ra_vmedian_0_1_0, 0), (self.Ra_Ascii_Sink_0, 0))
    ...
    def set_Gain3(self, Gain3):
        ...
        self.Ra_Ascii_Sink_0.set_gain3( self.Gain3)
        self._Gain3s_config = ConfigParser.ConfigParser()
        self._Gain3s_config.read(self.ConfigFile)
        if not self._Gain3s_config.has_section('main'):
        	self._Gain3s_config.add_section('main')
    ...
    def set_Gain2(self, Gain2):
        ...
        self.Ra_Ascii_Sink_0.set_gain2( self.Gain2)
        self._Gain2s_config = ConfigParser.ConfigParser()
        self._Gain2s_config.read(self.ConfigFile)
        if not self._Gain2s_config.has_section('main'):
        	self._Gain2s_config.add_section('main')
...
def main(top_block_cls=NsfIntegrate20, options=None):
