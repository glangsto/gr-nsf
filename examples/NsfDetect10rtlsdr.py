...
# Description: Rtlsdr 1st try
# Generated: Wed Jan 23 15:29:58 2019
##################################################
...
class NsfDetect10rtlsdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "NsfDetect10rtlsdr")
        ...
        # Variables
        ##################################################
        self.ConfigFile = ConfigFile = "Watch10.conf"
        ...
        self.connect((self.ra_vevent_0_0, 0), (self.ra_event_log_0, 0))
        self.connect((self.ra_vevent_0_0, 0), (self.ra_event_sink_0, 0))
        self.connect((self.rtlsdr_source_0, 0), (self.ra_vevent_0_0, 0))
...
def main(top_block_cls=NsfDetect10rtlsdr, options=None):
