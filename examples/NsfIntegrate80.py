...
# Generated: Mon Oct  8 08:23:18 2018
##################################################
...
class NsfIntegrate80(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pluto_source_0 = iio.pluto_source("", int(Frequency), int(Bandwidth), int(Bandwidth), 0x80000, True, False, True, "manual", Gain1, "", True)
